            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {mockDashboardMetrics.totalPnL >= 0 ? '+' : ''}{((mockDashboardMetrics.totalPnL / 10000) * 100).toFixed(2)}% from start
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            Avg: {formatCurrency(mockDashboardMetrics.totalPnL / mockDashboardMetrics.totalTrades)} per trade
                        </p>
                    </CardContent>
                </Card>
            </div>
